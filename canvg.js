...
function RGBColor(color_string){
    ...
    if(typeof color_string == 'string'){
	    ...
	    //     if (color_string == key || color_string == this.simple_colors[key]) {
	    //     	this.color = key;
	    //         this.hex = this.simple_colors[key];
	    //     }
	    // }
    ...
    }else if(Object.prototype.toString.call(color_string) === "[object Array]"){
    	this.r = color_string[0];
    	this.g = color_string[1];
    	this.b = color_string[2];
    	this.a = color_string[3];
    	// var color_hex = this.toHex().replace('#', '');
    	// for (var key in this.simple_colors) {
	    //     if (color_hex == this.simple_colors[key]) {
	    //     	this.color = key;
	    //         this.hex = this.simple_colors[key];
	    //     }
	    // }
...
RGBColor.prototype.toRGB = function () {
    return 'rgb(' + this.r + ', ' + this.g + ', ' + this.b + ', ' + this.b + ')';
}
